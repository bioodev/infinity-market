  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-fit">
      ...
      <div className="grid items-center justify-center w-full grid-cols-1 gap-4 p-4 lg:grid-cols-3">
        ...
        {cart.map((item) => (
          <div
            className="grid items-center justify-center h-full grid-cols-2 gap-2 px-4 py-2 text-xs text-center bg-white rounded shadow-sm lg:grid-cols-6 hover:shadow-md"
            key={item.id}
          >
